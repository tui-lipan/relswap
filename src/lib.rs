...
pub use release::{
    ...
    MAX_METADATA_SIZE, MAX_UNCOMPRESSED_SIZE, Manifest, PayloadInfo, ProgressObserver,
    ReleaseAsset, ReleaseError, ReleaseManifest, ReleaseMetadata, ReleaseTarget,
    Result as ReleaseResult, SelectedAsset, SignatureEntry, SignatureEnvelope, Target, TrustedKey,
    TrustedKeySet, UreqDownloader, VerifiedArchive, VerifiedMember, VerifiedSignature,
    extract_archive, extract_archive_file, fetch_exact_metadata, fetch_latest_metadata,
    fetch_latest_metadata_with_keys, fetch_version_metadata_with_keys, inspect_archive,
    sha256_bytes, sha256_file, sign_manifest, sign_manifest_bytes, sign_manifest_multi,
    verify_archive_bytes, verify_archive_file, verify_manifest, verify_manifest_with_keys,
};
