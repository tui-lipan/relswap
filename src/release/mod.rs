...
pub use signature::{
    SignatureEntry, SignatureEnvelope, TrustedKey, TrustedKeySet, VerifiedSignature, sign_manifest,
    sign_manifest_bytes, sign_manifest_multi, verify_manifest, verify_manifest_with_keys,
};
